# Natour - A Server Side Rendered Tour Booking Website
...
> -   Functionality of User login, reset account password using email is implemented.
> -   User can make payment, see all tours, give reviews on a tour.
